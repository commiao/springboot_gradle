...
public class RSAUtils {
	...
	public static String sign(byte[] data, String privateKey) throws Exception {
		byte[] keyBytes = Base64BouncycastleUtil.decode(privateKey);
		...
		return Base64BouncycastleUtil.encode(signature.sign());
	}
	...
	public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
		byte[] keyBytes = Base64BouncycastleUtil.decode(publicKey);
		...
		signature.update(data);
		return signature.verify(Base64BouncycastleUtil.decode(sign));
	}
	...
	public static String getPrivateKey(Map<String, Object> keyMap) throws Exception {
		...
		return Base64BouncycastleUtil.encode(key.getEncoded());
	}
